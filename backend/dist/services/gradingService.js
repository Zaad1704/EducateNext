...
exports.getGradingScale = exports.calculateClassRank = exports.calculateWeightedGPA = exports.calculateGPA = exports.calculateGrade = void 0;
...
exports.calculateWeightedGPA = calculateWeightedGPA;
const calculateClassRank = async (studentGPA, classroomId, academicYear, semester) => {
...
exports.calculateClassRank = calculateClassRank;
const getGradingScale = (institutionType = 'school') => {
    const scales = {
        school: {
    ...
    return scales[institutionType] || scales.school;
};
